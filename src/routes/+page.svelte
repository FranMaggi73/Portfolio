  ...
  >
    <nav class=" items-center flex flex-col">
      ...
      <div class="grid grid-cols-4 gap-4 justify-center">
        ...
        <a
          href="https://www.linkedin.com/in/fran-maggi-597467132/"
          aria-label="LinkedIn"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="https://mail.google.com/mail/?view=cm&fs=1&to=franmaggi73@gmail.com&su="
          aria-label="Gmail"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="https://github.com/FranMaggi73"
          aria-label="Github"
          target="_blank"
          rel="noopener noreferrer"
        >
