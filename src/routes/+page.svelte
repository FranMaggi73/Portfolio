  ...
  <div class="hero flex-1 flex justify-center items-center w-full basis-1/3">
    <div class="hero-content text-center">
      <div class="max-w-md">
        ...
        <button on:click={() => window.open('/cv.pdf')} class="btn btn-primary">Download Resume</button>
      </div>
    </div>
  </div>
  <footer class="footer bg-neutral text-neutral-content justify-center items-center flex-1 flex flex-col sm:pb-10">
    <nav class=" items-center flex flex-col">
      ...
      <div class="grid grid-cols-4 gap-4 justify-center">
        ...
        <a href="https://facebook.com" aria-label="Gmail">
          <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
